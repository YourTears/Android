package chat.leanchatlib.utils;
...
public class PhotoUtils {
  public static DisplayImageOptions avatarImageOptions = new DisplayImageOptions.Builder()
      .showImageOnLoading(AppConstant.defaultImageDrawable)
      .showImageForEmptyUri(AppConstant.defaultImageDrawable)
      .showImageOnFail(AppConstant.defaultImageDrawable)
      .cacheInMemory(true)
      .cacheOnDisc(true)
